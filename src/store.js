    ...
    return [
        makeReviseTemplate({
            ...
            prompt: 'เกลาข้อความต่อไปนี้ให้อ่านลื่นและเป็นธรรมชาติเหมือนคนเขียนมากขึ้น\n\n'
                + '■ กฎเหล็ก: ความยาวห้ามลดลง\n'
                + 'ผลลัพธ์ต้องมีความยาว (จำนวนคำ) เท่าเดิมหรือมากกว่าต้นฉบับเสมอ นี่คือการ "เกลา" ไม่ใช่ "ตัด"\n'
                + 'ทุกจุดที่ลบวลีหรือประโยคออกตามคำแนะนำด้านล่าง ต้องเขียนสิ่งใหม่แทนที่ในตำแหน่งเดิมทันที '
                + '(รายละเอียดที่จับต้องได้ / การกระทำเล็กๆ / จังหวะบทสนทนา) ห้ามลบแล้วปล่อยว่างเฉยๆ '
                + 'ก่อนส่งคำตอบ ให้ประเมินคร่าวๆ ว่าผลลัพธ์สั้นกว่าต้นฉบับหรือไม่ ถ้าสั้นกว่า ให้เขียนเพิ่มจนความยาวกลับมาอย่างน้อยเท่าเดิม\n\n'
                ...
                + '■ แทนที่ (ไม่ใช่ลบทิ้งเฉยๆ) — ทุกข้อต้องมีของใหม่มาแทนของเดิมที่ตัดไป\n'
                + '- "ไม่ใช่...แต่..." → เขียนตรงๆ\n'
                + '- การเรียงสามชิ้นทุกครั้ง ("เย็น เงียบ และว่างเปล่า") → เหลือหนึ่งที่คมกว่า แล้วเติมรายละเอียดอื่นชดเชยตรงจุดใกล้เคียง\n'
                + '- ประโยคสรุปปิดท้ายย่อหน้าที่อธิบายว่าย่อหน้านั้นแปลว่าอะไร → แทนด้วยภาพหรือการกระทำที่สื่อความหมายเดียวกันโดยไม่ต้องพูดตรงๆ\n'
                + '- การบอกชื่ออารมณ์หลังแสดงไปแล้ว ("...เธอรู้สึกเจ็บปวด") → แทนด้วยรายละเอียดทางกายหรือปฏิกิริยาที่เฉพาะเจาะจงกับตัวละครนี้\n'
                + '- วลีสวยหรูที่ไม่ให้ข้อมูล ("บางอย่างในอากาศเปลี่ยนไป") → แทนด้วยรายละเอียดจับต้องได้จริง (เสียง กลิ่น อุณหภูมิ การเคลื่อนไหว)\n\n'
                + '■ วลีต้องห้าม (คลิเช AI) — ห้ามใช้ซ้ำ แต่ต้องมีอะไรมาแทนที่เสมอ\n'
                ...
                + 'ถ้าจำเป็นต้องบรรยายปฏิกิริยาทางกาย ให้เลือกอาการที่เฉพาะเจาะจงกับตัวละครนี้และฉากนี้แทน\n\n'
                + '■ คำฟุ่มเฟือยที่ตัดได้จริงๆ (กลุ่มเดียวที่ตัดได้โดยไม่ต้องหาอะไรมาแทน)\n'
                + '"ราวกับ" "ดูเหมือนว่า" "เกือบจะ" "อย่างช้าๆ" "เบาๆ" ที่ไม่จำเป็น, ชื่อตัวละครที่ซ้ำเกินไป (ภาษาไทยละประธานได้)\n'
                + 'ระวังประโยคที่โครงสร้างเหมือนแปลจากอังกฤษ\n\n'
                + '■ ห้ามแก้\n'
                + 'เนื้อเรื่อง ลำดับเหตุการณ์ จำนวนย่อหน้า'
        ...
        makeReviseTemplate({
            ...
            prompt: 'ขยายข้อความต่อไปนี้ให้มีมิติขึ้น โดยไม่เพิ่มเหตุการณ์ใหม่\n\n'
                + '■ กฎเหล็ก: ผลลัพธ์ต้องยาวกว่าต้นฉบับอย่างน้อย 20% ถ้าสั้นกว่าหรือยาวใกล้เคียงเดิม '
                + 'ถือว่าทำงานผิดพลาด ให้เขียนเพิ่มจนยาวขึ้นจริงก่อนส่งคำตอบ\n\n'
                ...
                + '- ห้ามยืดด้วยคำฟุ่มเฟือยหรือวลีคลิเช — ขยายด้วยรายละเอียดที่มีความหมายจริงเท่านั้น'
                + reviseStandardEnding(),
        }),
        makeReviseTemplate({
            name: 'เพิ่มบทสนทนา',
            prompt: 'ปรับสัดส่วนของข้อความต่อไปนี้ให้มีบทสนทนามากขึ้น\n\n'
                + 'ความยาวรวมต้องไม่สั้นกว่าต้นฉบับ — งานนี้คือ "เติม" บทสนทนาเข้าไป ไม่ใช่ตัดคำบรรยายออกเฉยๆ\n\n'
        ...
        makeReviseTemplate({
            ...
            prompt: 'ตรวจข้อความต่อไปนี้เทียบกับการ์ดตัวละคร ข้อมูลโลก และบทสนทนาที่ผ่านมา\n\n'
                ...
                + 'ถ้าพบ ให้แก้เฉพาะประโยคที่ขัดแย้งจริงๆ ส่วนที่เหลือคงไว้คำต่อคำ '
                + 'ห้ามเกลาสำนวนหรือปรับความยาวส่วนอื่นทั้งหมด แก้เฉพาะความขัดแย้งเท่านั้น'
                + reviseStandardEnding(),
        }),
        makeReviseTemplate({
            name: 'ตามคำสั่ง',
